...
public class ASLP_HTTP_KeyTest extends LocalAPITestCase implements ASLP {

	public String getTestCaseName() {
		return "App开发/ASLP/HTTP Key鉴权";
	}

	// 测试http服务调用方式
	public boolean execute(Map<String, Object> params) {
		EngineDebug.info("该测试用例实现了ASLP接口，并模拟调用方通过HTTP+Key的鉴权方式给该App发送订单id，获得订单明细数据");
		params = new HashMap<String, Object>();
		try {
			// 成功运行，需在该App增加ASLP-KEY参数，其值设置为2014
			String authentication = "2014";
			Map<String, Object> httpData = UtilJson.getMapByUrl("http://localhost:8088/portal/r/jd?cmd=API_CALL_ASLP&sourceAppId=com.actionsoft.apps.poc.api&aslp=aslp://com.actionsoft.apps.poc.api/getOrderByKey&params={\"orderId\":\"123456\"}&authentication=" + authentication);
