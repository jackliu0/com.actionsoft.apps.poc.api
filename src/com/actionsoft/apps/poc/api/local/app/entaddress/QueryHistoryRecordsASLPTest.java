...
public class QueryHistoryRecordsASLPTest extends LocalAPITestCase {

	public String getTestCaseName() {
		return "App开发/单位通讯录/获取查看历史";
	}
	...
	public boolean execute(Map<String, Object> params) {
		...
		if (app != null) {
			...
			// 服务地址
			String aslp = "aslp://com.actionsoft.apps.entaddress/queryHistoryRecords";
