...
public class AppNotificationAPITest2 extends LocalAPITestCase {
	public static String systemName = "API测试-自定义消息";

	public String getTestCaseName() {
		return "App开发/通知/自定义通知";
	}
	...
	public boolean execute(Map<String, Object> params) {
		...
		if (notificationApp != null) {
			...
			try {
				...
				json.put("data", "Hello Notification, This is Info!");
				json.put("id", "1");
				...
				params.put("targetIds", "admin");
				json = new JSONObject();
				json.put("data", "Hello Notification, This is Warning!");
				json.put("id", "2");
				params.put("content", json.toString());
				...
				params.put("targetIds", "admin");
				json = new JSONObject();
				json.put("data", "Hello Notification, This is Error!");
				json.put("id", "3");
				params.put("content", json.toString());
				...
				params.put("targetIds", "admin");
				json = new JSONObject();
				json.put("data", "Hello Notification, This is Infomation!");
				json.put("id", "4");
				params.put("content", json.toString());
				params.put("level", "info");
				params.put("systemName", systemName);
